...
export const resetPassword = catchAsyncErrors(async(req, res, next) => {
    ...
    if(req.body.password.length < 8 || req.body.password.length > 16 || req.body.confirePassword.length < 8 || req.body.confirmPassword.length > 16){
...
export const updatePassword = catchAsyncErrors(async(req, res, next) => {
    ...
    if(newPassword.length < 8 ||newPassword.length > 16 || confirePassword.length < 8 || confirmPassword.length > 16){
        return next(new ErrorHandler("Password must be between 8 and 16 characters", 400));
    }
